...
if __name__ == "__main__":
    ...
    if success_1 and success_2:
        print(
            "Local fixes successful! You should now be able to infer and train locally on crepe RVC."
        )
    else:
        print(
            "Local fixes didn't apply? You shouldn't be seeing this if you ran it in the correct folder. Otherwise, contact kalomaze#2983 in AI HUB"
        )
