        ...
        if DoFormant:
            ...
            if not file.endswith(".wav"):
                if not os.path.isfile(f"{file_formanted}.wav"):
                    converted = True
                    converting = (
                        _ffmpeg.input(file_formanted, threads = 0)
            ...
            out, _ = (
                _ffmpeg.input(f"{file_formanted}FORMANTED_{str(numerator)}.wav", threads=0)
